...
// Use Cases
import { AuthenticateUseCase } from "@/use-cases/user/bitbucket-authenticate";
...
export const bitbucketCallback = async (
	req: FastifyRequest,
	res: FastifyReply
) => {
	...
	const repoClientService = new RepoClientService(ProviderType.BITBUCKET);
